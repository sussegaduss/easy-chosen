...
(function() {
    ...
    Chosen = (function() {
        ...
        Chosen.prototype.test_iso8859_chars = function(value) {
           return value.
                   replace(/ã/g,"a").
                   replace(/Ã/g,"A").
                   replace(/à/g,"a").
            ...
            for (_i = 0,_len = _ref.length; _i < _len; _i++) {
                ...
                if (!option.disabled && !option.empty) {
                    if (option.group) {
                        ...
                        //TODO: AKI
                        var replaceChar = this.test_iso8859_chars(option.html);
                        if (regex.test(option.html) || regex.test(replaceChar)){
                            found = true;
                            results += 1;
                        ...
                        if (found) {
                            if (searchText.length) {
                                //TODO: AKI
                                startpos = replaceChar.search(zregex);
